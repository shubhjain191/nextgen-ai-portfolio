...
import { Github, Linkedin, Twitter, Globe, Newspaper, Code2, Youtube } from "lucide-react";
                ...
                <div className="pt-6">
                  ...
                  <div className="flex flex-wrap gap-2 @md/info:gap-3">
                    {profile.socialLinks.github && (
                      ...
                      >
                        <Github className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        GitHub
                      </Link>
                    )}
                    {profile.socialLinks.linkedin && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Linkedin className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        LinkedIn
                      </Link>
                    )}
                    {profile.socialLinks.twitter && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Twitter className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        Twitter
                      </Link>
                    )}
                    {profile.socialLinks.website && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Globe className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        Website
                      </Link>
                    )}
                    {profile.socialLinks.medium && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Newspaper className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        Medium
                      </Link>
                    )}
                    {profile.socialLinks.devto && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Code2 className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        Dev.to
                      </Link>
                    )}
                    {profile.socialLinks.youtube && (
                      <Link
                        ...
                        className="px-3 py-1.5 @md/info:px-4 @md/info:py-2 rounded-lg border hover:bg-accent transition-colors text-xs @md/info:text-sm flex items-center gap-2"
                      >
                        <Youtube className="w-3.5 h-3.5 @md/info:w-4 @md/info:h-4" />
                        YouTube
                      </Link>
                    )}
                  </div>
